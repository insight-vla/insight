...
def main(repo_id: str, output_dir: str = "", num_episodes_per_task: int = 3, fps: int = 10):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--repo_id", type=str, default="maggiewang/lego_primitives_01_30",
                        help="LeRobot dataset repo ID")
    parser.add_argument("--output_dir", type=str, default="",
                        help="Output directory for videos")
    parser.add_argument("--num_episodes_per_task", type=int, default=3,

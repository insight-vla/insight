...
def get_roboarena_configs():
    # Import directly from sim_configs (where these are defined). config.py
    # is a thin shim that re-exports them, so importing via config.py creates
    # a circular dependency while sim_configs is mid-load.
    from openpi.training.sim_configs import AssetsConfig
    from openpi.training.sim_configs import DataConfig
    from openpi.training.sim_configs import SimpleDataConfig
    from openpi.training.sim_configs import TrainConfig

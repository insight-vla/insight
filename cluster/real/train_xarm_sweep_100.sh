...
#SBATCH --job-name="pi05_sweep100_1gpu"
...
NORM_STATS_FILE="assets/xarm_sweep_100_04_20/maggiewang/xarm_sweep_100_04_17/norm_stats.json"
if [ ! -f "$NORM_STATS_FILE" ]; then
    echo "Computing norm stats..."
    uv run scripts/compute_norm_stats.py --config-name xarm_sweep_100_04_20
else
    echo "Norm stats already exist, skipping..."
fi

uv run scripts/train.py xarm_sweep_100_04_20 --exp-name=xarm_sweep_100_04_20_rtxpro_ah16_1gpu --batch-size 64 --fsdp-devices 1
